// src/components/features/matching/sections/CompatibilitySection.js - Updated with CSS module
...
const CompatibilitySection = ({
  ...
  return (
    <>
      ...
      <div className={styles.checkboxColumnsCompact || 'checkbox-columns-compact mb-4'}>
        <label className={styles.checkboxLabel || 'checkbox-label'}>
          <input
            type="checkbox"
            ...
            disabled={loading}
          />
          <span className={styles.checkboxText || 'checkbox-text'}>I own pets</span>
        </label>
        ...
        <label className={styles.checkboxLabel || 'checkbox-label'}>
          <input
            ...
            disabled={loading}
          />
          <span className={styles.checkboxText || 'checkbox-text'}>I'm comfortable with roommate's pets</span>
        </label>
        ...
        <label className={styles.checkboxLabel || 'checkbox-label'}>
          <input
            ...
            disabled={loading}
          />
          <span className={styles.checkboxText || 'checkbox-text'}>Overnight guests are OK</span>
        </label>
        ...
        <label className={styles.checkboxLabel || 'checkbox-label'}>
          <input
            ...
            disabled={loading}
          />
          <span className={styles.checkboxText || 'checkbox-text'}>I'm open to sharing groceries</span>
        </label>
      </div>
      ...
      {/* ✅ UPDATED: Using CSS module for housing assistance subtitle */}
      ...
      <div className="form-group mb-4">
        ...
        <div className={styles.checkboxColumnsCompact || 'checkbox-columns-compact'}>
          {housingSubsidyOptions.map(subsidy => (
            <label key={subsidy.value} className={styles.checkboxLabel || 'checkbox-label'}>
              <input
                type="checkbox"
                ...
                disabled={loading}
              />
              <span className={styles.checkboxText || 'checkbox-text'}>{subsidy.label}</span>
            </label>
          ))}
        </div>
      </div>
      ...
      <div className="form-group mb-4">
        ...
        {/* ✅ UPDATED: Using CSS module for regular checkbox columns */}
        <div className={styles.checkboxColumns || 'checkbox-columns'}>
          {interestOptions.map(interest => (
            <label key={interest} className={styles.checkboxLabel || 'checkbox-label'}>
              <input
                type="checkbox"
                ...
                disabled={loading}
              />
              <span className={styles.checkboxText || 'checkbox-text'}>{interest}</span>
            </label>
          ))}
        </div>
        {errors.interests && (
      ...
      {/* Profile Status */}
      <div className="form-group mb-4">
        {/* ✅ UPDATED: Using CSS module for enhanced checkbox label */}
        <label className={styles.checkboxLabel || 'checkbox-label'}>
          <input
            type="checkbox"
            ...
            disabled={loading}
          />
          <span className={styles.checkboxText || 'checkbox-text'}>Keep my profile active for matching</span>
        </label>
        <div className="text-gray-500 mt-1 text-sm">
