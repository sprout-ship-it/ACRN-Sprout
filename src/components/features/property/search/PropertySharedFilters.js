// src/components/features/property/search/PropertySharedFilters.js - Reorganized Shared Search Filters
...
const PropertySharedFilters = ({
  ...
  // ✅ Utility options that match our form sections
  ...
  return (
    <div className={styles.sharedFiltersContainer}>
      {/* ✅ SECTION 1: Location & Basic Search */}
      ...
      {/* ✅ SECTION 3: Property Features & Amenities */}
      <div className="card mb-4">
        <div className="card-header">
          <h3 className="card-title">
            <span className={styles.sectionIcon}>⭐</span>
