...
transformSchemaCompliantProfile(dbProfile) {
  ...
  return {
    ...
    // PERSONAL DETAILS (exact schema fields) - FIXED: Remove || []
    primary_phone: dbProfile.primary_phone,
    date_of_birth: dbProfile.date_of_birth,
    
    // GENDER & IDENTITY (exact schema fields) - FIXED: Remove || []
    ...
    // LOCATION (exact schema fields) - FIXED: Remove || []
    ...
    // BUDGET & FINANCIAL (exact schema fields) - FIXED: Remove || []
    ...
    // RECOVERY & WELLNESS (exact schema fields) - FIXED: Remove || []
